...
public class IniciarSesionFrame extends javax.swing.JFrame {
    ...
    private void botonaceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonaceptarActionPerformed
        ...
        Persona.setUsuario(ConsultasSQL.consulta.buscarPersona(dnifield.getText(), contraseñafield.getText()));

        System.out.println("Sesion iniciada");
        FramePrincipal.fprincipal.sesion = true;  //Se ha iniciado sesion
        FramePrincipal.fprincipal.visibilidadBotones(); //Cambia los botones que están Enabled ahora
        super.dispose();
